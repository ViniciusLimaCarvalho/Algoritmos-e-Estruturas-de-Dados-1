...
int main(){
    ...
    while(1){
        do{
            ...
            printf("4)Fazer intersecao de duas listas\n");
            printf("5)Sair\n");
            scanf("%d",&escolha);
        ...
        if(escolha == 1){
            if(vezes != 0){
                do{
                    ...
                    printf("4)Inserir no fim sem repeticao\n");
                    scanf("%d",&escolha2);
            ...
            if(escolha2 == 1){
                ...
                inserirNoFinalSemRepeticao(l,aux);
                mostrar(l);
            }
